...
// Returns a noun phrase containing the specified noun
string Dictionary::getNP(string& oneNoun) {
	int option = getRandomNumber(1, 3);
	...
	case 1:
		return oneNoun;
	case 2:
		return getArticle() + " " + oneNoun;
	case 3:
		return getNP(oneNoun) + " " + getPP();
	}
}


// Returns a random verb phrase
string Dictionary::getVP() {
	int option = getRandomNumber(1, 4);
	...
	case 2:
		return getVP() + " " + getNP();
	case 3:
		return getVP() + " " + getAdjective();
	case 4:
		return getVP() + " " + getAdverb();
	}
}


// Returns a verb phrase containing the specified verb
string Dictionary::getVP(string& oneVerb) {
	int option = getRandomNumber(1, 4);
	...
	case 1:
		return oneVerb;
	case 2:
		return getVP(oneVerb) + " " + getNP();
	case 3:
		return getVP(oneVerb) + " " + getAdjective();
	case 4:
		return getVP(oneVerb) + " " + getAdverb();
	}
}


// Returns a random Prepositional phrase
string Dictionary::getPP() {
		return getPreposition() + " " + getNP();
	}